...
new stepsForm(theForm, {
  onSubmit: function (form) {
    ...
    emailjs.init('oM-zA7uxhIYl8tRpk');
    const serviceId = "service_cfa2iuy";
    const templeteId = "template_d4tfbjm";
    // these IDs from the previous steps
    emailjs.sendForm(serviceId, templeteId, theForm)
      .then(function () {
        console.log('SUCCESS!');
      }, function (error) {
